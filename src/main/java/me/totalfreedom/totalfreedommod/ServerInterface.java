...
public class ServerInterface extends FreedomService
{
    ...
    public static void warnVersion()
    {
        ...
        {
            FLog.warning(TotalFreedomMod.pluginName + " is compiled for " + COMPILE_NMS_VERSION + " but the server is currently running version " + nms + "!");
            FLog.warning("This might result in some wierd stuff happening, dont report this if that is the case!");
        }
    }
