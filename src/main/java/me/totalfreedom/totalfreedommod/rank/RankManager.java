...
public class RankManager extends FreedomService
{
    ...
    public RankBase getDisplay(CommandSender sender)
    {
        ...
        if (MainConfig.get(ConfigEntry.SERVER_COOWNERS, List.class).contains(player.getName()))
        {
            return Title.COOWNER;
        }
        if (MainConfig.get(ConfigEntry.SERVER_DONATORS, List.class).contains(player.getName()))
        {
