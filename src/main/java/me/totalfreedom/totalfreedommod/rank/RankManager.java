...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        if (FUtil.MFDEVELOPERS.contains(player.getName()))
        {
            return Title.MFDEVELOPER;
        }
    ...
    public Rank getRank(CommandSender sender)
    {
        ...
        {
            return ConfigEntry.ADMINLIST_CONSOLE_IS_EXEC.getBoolean() ? Rank.EXECUTIVE_CONSOLE : Rank.TELNET_CONSOLE;
        }
